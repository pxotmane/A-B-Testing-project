...
SELECT table2.rep_name, table2.region_name, table2.total_amt
FROM table1
JOIN table2
ON table2.region_name = table1.region_name AND table2.total_amt = table1.max_total_amt;
/* Udacity solution*/
WITH t1 AS (
  SELECT s.name rep_name, r.name region_name, SUM(o.total_amt_usd) total_amt
   FROM sales_reps s
